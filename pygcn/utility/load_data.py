...
class Data(object):
    def __init__(self, path, dataset, batch_size, K):
        self.path = path
    ...
    def get_adj_mat(self):
        try:
            t1 = time()
            adj_mat = sp.load_npz(self.path + self.dataset + '/s_adj_mat.npz')
            norm_adj_mat = sp.load_npz(self.path + self.dataset + '/s_norm_adj_mat.npz')
            mean_adj_mat = sp.load_npz(self.path + self.dataset + '/s_mean_adj_mat.npz')
            adj_mat_personality = sp.load_npz(self.path + self.dataset + '/s_adj_mat_personality.npz')
            norm_adj_mat_personality = sp.load_npz(self.path + self.dataset + '/s_norm_adj_mat_personality.npz')
            mean_adj_mat_personality = sp.load_npz(self.path + self.dataset + '/s_mean_adj_mat_personality.npz')
            ...
            sp.save_npz(self.path + self.dataset + '/s_adj_mat.npz', adj_mat)
            sp.save_npz(self.path + self.dataset + '/s_norm_adj_mat.npz', norm_adj_mat)
            sp.save_npz(self.path + self.dataset + '/s_mean_adj_mat.npz', mean_adj_mat)
            sp.save_npz(self.path + self.dataset + '/s_adj_mat_personality.npz', adj_mat_personality)
            sp.save_npz(self.path + self.dataset + '/s_norm_adj_mat_personality.npz', norm_adj_mat_personality)
            sp.save_npz(self.path + self.dataset + '/s_mean_adj_mat_personality.npz', mean_adj_mat_personality)
    ...
    def get_sparsity_split(self):
        try:
            ...
            lines = open(self.path + self.dataset + '/sparsity.split', 'r').readlines()
            ...
            f = open(self.path + self.dataset + '/sparsity.split', 'w')
